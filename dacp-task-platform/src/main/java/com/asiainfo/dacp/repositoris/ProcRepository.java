...
public class ProcRepository {
	...
	public ProcScheduleInfo querySchedInfo(String xmlid,String dataSource) {
		...
		try{
			...
			("select * from proc_schedule_info  where xmlid=?",new Object[]{xmlid},new RowMapper(){
				public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					context.setPrecmd(rs.getString("pre_cmd"));
					context.setMax_run_hours(rs.getInt("max_run_hours"));
					context.setTask_group(rs.getString("task_group"));
					context.setTask_group_name(rs.getString("task_group_name"));
	...
	public Proc queryProcByid(String xmlid,String dataSource) {
		JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
		try{
			@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	public List<ProcScheduleRunpara> queryRunpara(String xmlid,String dataSource) {
